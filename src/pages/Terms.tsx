  ...
  return (
    <div className="min-h-screen py-12 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="font-serif text-3xl md:text-4xl font-bold text-navy dark:text-text-primary-dark mb-2">
          Terms of Use
        </h1>
        ...
        <div className="prose prose-navy dark:prose-invert max-w-none">
          ...
          <h2 className="font-serif text-xl font-bold text-navy dark:text-text-primary-dark mt-8 mb-4">
            1. Service Description
          </h2>
          <p className="text-text-secondary dark:text-text-secondary-dark mb-4">
            WikiWander is an iOS application that provides:
          </p>
          <ul className="list-disc pl-6 text-text-secondary dark:text-text-secondary-dark mb-6 space-y-2">
